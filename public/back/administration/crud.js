...
/* recuperation de bd ê */
    ...
    data.forEach((element, index) => {
      datesLeft.innerHTML = datesLeft.innerHTML + `<li class="wow fadeInRight highlight lhgh" data-index="${index}"> <span>${element.date}</span><div class=\"fl-inner\"><h4> ${element.title}</h4><p>PARC DEL FORUM</p> <a href=\"./php/liste_groupe1.php\"> Billets  </a></div></li>`;
    });
    ...
    data.forEach((element, index) => {
      datesRight.innerHTML = datesRight.innerHTML + `<li class="wow fadeInRight highlight lhgh" data-index="${index}"> <span>${element.date}</span><div class=\"fl-inner\"><h4> ${element.title}</h4><p>PARC DEL FORUM</p> <a href=\"./php/liste_groupe1.php\"> Billets  </a></div></li>`;
    });
